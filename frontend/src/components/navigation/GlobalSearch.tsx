...
const PAGE_INDEX: SearchResult[] = [
  ...
  { id: "p-modalidades",  label: "Modalidades Pedagogicas", category: "Página", path: "/modalidades",                     icon: <Category fontSize="small" />,           type: "page" },
  { id: "p-modalidades-fin", label: "Modalidades Financeiras", category: "Página", path: "/modalidades-financeiras",       icon: <Calculate fontSize="small" />,          type: "page" },
