...
(async () => {
  try {
    console.log('Verificando estrutura da tabela estoque_movimentacoes...');
    
    // Verificar colunas da tabela estoque_movimentacoes
    ...
    console.log('\nColunas da tabela estoque_movimentacoes:');
    ...
    try {
      const sample = await pool.query('SELECT * FROM estoque_movimentacoes LIMIT 3');
