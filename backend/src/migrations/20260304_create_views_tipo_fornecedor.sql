-- Migration: Criar views para relatórios de tipo de fornecedor
-- Data: 2026-03-04
-- Descrição: Views para análise de compras e faturamento por tipo de fornecedor
...
-- Comentários
COMMENT ON VIEW vw_pedido_resumo_tipo_fornecedor IS 'Resumo de compras por tipo de fornecedor em cada pedido';
COMMENT ON VIEW vw_faturamento_tipo_fornecedor_modalidade IS 'Resumo de faturamento por tipo de fornecedor e modalidade';
COMMENT ON VIEW vw_faturamento_detalhado_tipo_fornecedor IS 'Detalhamento completo de faturamento incluindo tipo de fornecedor';
