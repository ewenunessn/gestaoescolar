-- Migration: Add observacao and para_entrega columns to guia_produto_escola table
-- Created: 2024-12-23

-- Add observacao column to guia_produto_escola table
...
-- Update existing records to have default para_entrega value
