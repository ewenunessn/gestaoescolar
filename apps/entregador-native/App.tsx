...
import EstoqueCentralTransferenciaScreen from './src/screens/EstoqueCentralTransferenciaScreen';
import EstoqueCentralRelatoriosScreen from './src/screens/EstoqueCentralRelatoriosScreen';
import EstoqueCentralMovimentacoesScreen from './src/screens/EstoqueCentralMovimentacoesScreen';
      ...
      <OfflineProvider>
        <NavigationContainer>
          ...
          >
            ...
            />
            <Stack.Screen
              name="EstoqueCentralMovimentacoes"
              component={EstoqueCentralMovimentacoesScreen}
            ...
            />
            <Stack.Screen
              name="EstoqueCentralTransferencia"
              component={EstoqueCentralTransferenciaScreen}
              options={{ title: 'Transferir para Escola' }}
            />
            <Stack.Screen
              name="EstoqueCentralRelatorios"
              component={EstoqueCentralRelatoriosScreen}
              options={{ title: 'Relatorios do Estoque' }}
            />
            <Stack.Screen
              name="Recebimentos"
            ...
            <Stack.Screen
              ...
              options={{ title: 'Pedidos Concluidos' }}
            />
            <Stack.Screen
